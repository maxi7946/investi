            ...
            return function() {
                    if (!b || !b.requirejs) {
                        ...
                        ! function(b) {
                            ...
                            function f(a, b) {
                                var c, d, e, f, g, h, i, j, k, l, m, n, o = b && b.split("index.html"),
                                    p = t.map,
                                    q = p && p["*"] || {};
                                if (a) {
                                    for (a = a.split("index.html"), g = a.length - 1, t.nodeIdCompat && x.test(a[g]) && (a[g] = a[g].replace(x, "")), "." === a[0].charAt(0) && o && (n = o.slice(0, o.length - 1), a = n.concat(a)), k = 0; k < a.length; k++)
                                ...
                                if ((o || q) && p) {
                                    for (c = a.split("index.html"), k = c.length; k > 0; k -= 1) {
                                        if (d = c.slice(0, k).join("index.html"), o)
                                            for (l = o.length; l > 0; l -= 1)
                                                if ((e = p[o.slice(0, l).join("index.html")]) && (e = e[d])) {
                                                    f = e, h = k;
                                                    break
                                                }
                                        if (f) break;
